...
/**
 * Existing POS hooks are public integration points and are intentionally kept stable.
 *
 * rootlabs-pos-pro-w2a-hook-compat
 *
    ...
    public function cancel(int $userId, int $saleId, string $reason, string $clientRequestId): array|WP_Error
    {
        ...
        $this->saleRepo->create_log([
            ...
            'message'    => sprintf(
                ...
                __('Order #%1$s cancelled — %2$s.', 'mx-pos-pro'),
